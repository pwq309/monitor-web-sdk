...
var _safestr = require('./safestr');

var _safestr2 = _interopRequireDefault(_safestr);
...
var isError = _utils2.default.isError;
var isErrorEvent = _utils2.default.isErrorEvent;
...
var objectMerge = _utils2.default.objectMerge;
var hasKey = _utils2.default.hasKey;
var joinRegExp = _utils2.default.joinRegExp;
var htmlTreeAsString = _utils2.default.htmlTreeAsString;
var parseUrl = _utils2.default.parseUrl;
var fill = _utils2.default.fill;
var supportsFetch = _utils2.default.supportsFetch;
var isKSongBiz = _utils2.default.isKSongBiz;
var isOverseaBiz = _utils2.default.isOverseaBiz;
var isMoyiBiz = _utils2.default.isMoyiBiz;
var isCrushBiz = _utils2.default.isCrushBiz;
var isMirthBiz = _utils2.default.isMirthBiz;
var isLookBiz = _utils2.default.isLookBiz;
var isIplayBiz = _utils2.default.isIplayBiz;
...
var Corona = function () {
    ...
    Corona.prototype.captureException = function captureException(ex, options, type) {
        ...
        this._baseData.json.content = (0, _safestr2.default)(stack);
    ...
    Corona.prototype.captureMessage = function captureMessage(msg, options, type) {
        ...
        this._baseData.json.content = (0, _safestr2.default)(content);
    ...
    */
    ...
    Corona.prototype._instrumentBreadcrumbs = function _instrumentBreadcrumbs() {
        ...
        if (autoBreadcrumbs.console && 'console' in window && console.log) {
            ...
            each(['info', 'warn', 'error'], function (_, level) {
                (0, _console.wrapMethod)(console, level, consoleMethodCallback);
            });
        }
    };
    ...
    Corona.prototype._isRepeatData = function _isRepeatData(current) {
        ...
        var cur = (0, _safestr2.default)(feature);
    ...
    Corona.prototype._makeRequest = function _makeRequest(opts) {
        ...
        var bodyData = 'logs=' + encodeURIComponent((0, _safestr2.default)(opts.data));
